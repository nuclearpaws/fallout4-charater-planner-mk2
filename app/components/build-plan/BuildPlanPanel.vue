...
<template>
  <section class="tab-panel plan-panel">
    ...
    <AlertMessage v-if="unfilledLevelCount" type="warning">This route has {{ unfilledLevelCount }} unfilled level{{ unfilledLevelCount === 1 ? '' : 's' }}. Add more perk ranks or use those levels for SPECIAL increases.</AlertMessage>
